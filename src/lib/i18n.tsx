...
const en: Dict = {
  ...
  reqSending: 'Sending…',
  reqSubmit: 'Submit',
  reqSuccessTitle: 'Request received!',
  reqSuccessBody: 'Your store request is in the queue. The team will review it and send you your login credentials once the store is live.',
...
const ar: Dict = {
  ...
  reqSubmit: 'إرسال',
  reqSuccessTitle: 'تم استلام طلبك!',
  reqSuccessBody: 'طلبك في قائمة الانتظار. سيراجعه الفريق ويرسل لك بيانات الدخول فور إطلاق المتجر.',
